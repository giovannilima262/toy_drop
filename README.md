...
Merge-física estilo Suika com o Kenney Toy Brick Pack, feito para CrazyGames.
...
- Os stubs estão em `js/game.js` no objeto `SDK` — trocar pelo SDK real da CrazyGames.
